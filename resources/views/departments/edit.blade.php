            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <form method="POST" action="{{ route('departments.update', $department->id) }}">
                    ...
                    <div>
                        ...
                        <x-text-input id="department_name" class="block mt-1 w-full" type="text" name="department_name"
                    ...
                    <div class="flex space-y-4 gap-5">
                        ...
                        <div class="mt-4 w-full">
                            ...
                            <x-text-input id="max_clock_in_time" class="block mt-1 w-full" type="time"
                                name="max_clock_in_time" :value="old('max_clock_in_time', $department->max_clock_in_time)" required />
                        ...
                        <div class="mt-4 w-full">
                            ...
                            <x-text-input id="max_clock_out_time" class="block mt-1 w-full" type="time"
                                name="max_clock_out_time" :value="old('max_clock_out_time', $department->max_clock_out_time)" required />
